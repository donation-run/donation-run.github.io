...
var answer = [
    'http://www.foodforthepoor.org/Hunger',
    'https://www.unicefusa.org/donate/help-save-childrens-lives/29091?utm_campaign=2016_misc&utm_medium=cpc&utm_source=20160210_google&utm_content=donate_children&ms=cpc_dig_2016_misc_20160210_google_donate_children&initialms=cpc_dig_2016_misc_20160210_google_donate_children‎', 
    'https://secure.feedingamerica.org/site/Donation2;jsessionid=D79C71728D4047C151045D89C724C0E4.app248a?df_id=15040&15040.donation=form1&s_onsite_promo=MainNav_Donate&s_src=W168DIRCT&s_subsrc=http%3A%2F%2Fwww.feedingamerica.org%2FOfficialSite&_ga=1.194352426.641825067.1470154851',
    'https://www.freedomfromhunger.org/donation/online‎',
    'http://donate.worldvision.org/ways-to-give/hunger',
    'http:///www.nokidhungry.org/give/overview',
    'https://donate.feedthechildren.org/donation/bd1b6928/',
    'http://www.feedingamerica.org/ways-to-give/',
    'https://www.gocopia.com/?gclid=CjwKEAjwiYG9BRCkgK-G45S323oSJABnykKA7zS7mGJdEW2z1AHBdQv3ecZiOlcGInx209_Hi5NhNBoCoJbw_wcB#/',
    'http://www.stophungernow.org/donate/',
    'https://childsponsorship.feedthechildren.org/',
    'http://www.actionagainsthunger.org/take-action/donate',
    'http://cdn.wfp.org/donate/?lead_source=2014-wfp-donateheader&form_tag=2014-wfp-donateheader',
    'https://www.nokidhungry.org/give/overview'    
]
...
function init() {
    ...
    manifest = [
        {src: "unnamed.png", id: "ashlyn"},
        {src: "sky.png", id: "sky"},
        {src: "ground.png", id: "ground"},
        {src: "hill1.png", id: "hill"},
        {src: "hill2.png", id: "hill2"},
        {src: "burger.png", id: "dog"},
        {src: "apple.png", id: "dogbone"},
...
function handleComplete() {
    ...
    var spriteSheet = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 398, "count": 2, "regY": 0, "width": 398},
    ...
    var spriteSheet2 = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 112, "count": 1, "regY": 0, "width": 136},
            //define two animations, run (loops, 1.5x speed) and jump (returns to run):
            "animations": {
                //"run": 1
                //"jump": [2, "run"]
        ...
        var spriteSheet3 = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 82, "count": 1, "regY": 0, "width": 70},
            //define two animations, run (loops, 1.5x speed) and jump (returns to run):
            "animations": {
                //"run": 1
                //"jump": [2, "run"]
