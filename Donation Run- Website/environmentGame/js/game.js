...
var answer = [
    'http://www.nongmoproject.org/take-action/',
    ...
    'http://gmoinside.org/take-action/',
    'https://www.change.org/p/coca-cola-stop-funding-anti-gmo-labeling-campaigns',
    'http://www.justlabelit.org',
    'http://www.justlabelit.org/action-center/take-action/',
    'https://gmo-awareness.com/resources/anti-gmo-groups-america/',
    'http://petitions.moveon.org/sign/safeway-starbucks-and',
    'https://www.facebook.com/notes/susan-brown/-gmo-and-food-safety-petitions-to-sign-take-action-worldwide-updated-december-20/202812023207767/',
    'https://www.geneticliteracyproject.org/2015/11/17/anti-gmo-ngos-petition-obama-fda-toughen-regulations/'     
]
...
function init() {
    ...
    manifest = [
        {src: "spritedeli.png", id: "ashlyn"},
        {src: "sky.png", id: "sky"},
        {src: "ground.png", id: "ground"},
        {src: "hill1.png", id: "hill"},
        {src: "hill2.png", id: "hill2"},
        {src: "strawberry.png", id: "dog"},
        {src: "banana.png", id: "dogbone"},
...
function handleComplete() {
    ...
    var spriteSheet = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 164, "count": 2, "regY": 0, "width": 171},
    ...
    var spriteSheet2 = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 139 , "count": 1, "regY": 0, "width": 129},
            //define two animations, run (loops, 1.5x speed) and jump (returns to run):
            "animations": {
                //"run": 1
                //"jump": [2, "run"]
        ...
        var spriteSheet3 = new createjs.SpriteSheet({
            ...
            "frames": {"regX": 0, "height": 125, "count": 1, "regY": 0, "width": 124},
            //define two animations, run (loops, 1.5x speed) and jump (returns to run):
            "animations": {
                //"run": 1
                //"jump": [2, "run"]
